;!nasm -felf64 array_sort.asm && gcc -no-pie array_sort.o -o array_sort && ./array_sort Write a program which reads 5 numbers into an array, sorts/arranges the numbers from
